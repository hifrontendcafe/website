...
const Hero: React.FC<HeroProps> = ({ title, handleIniciativasClick }) => {
  return (
    <div className="relative py-32 mx-auto bg-white/0">
      <div className="flex items-center justify-center h-full bg-center bg-cover text-zinc-50 md:justify-around">
        <div className="z-10 w-auto text-center">
          <div className="flex flex-col items-center">
            <div className="mb-16">
              ...
              <p className="max-w-xl mx-auto mt-4 text-xl font-medium text-zinc-300 md:text-2xl">
            ...
            <button
              ...
              className="flex items-center self-center justify-center font-semibold text-zinc-50"
            >
