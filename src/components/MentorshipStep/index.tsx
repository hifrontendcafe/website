...
const evenStep = {
    container: 'relative flex items-center w-96 h-24 bg-primary px-6 my-6 ml-20 rounded-bl-full rounded-tl-full',
    ...
    text: 'w-72 pl-2 text-xs text-white font-semibold font-sans'
}

const oddStep = {
    container: 'relative flex justify-end items-center w-96 h-24 bg-white px-6 ml-14 my-6 rounded-br-full rounded-tr-full',
    circle: 'absolute -left-14 -top-2.5 w-28 h-28 bg-primary rounded-full font-bold align-middle text-center',
    step: 'text-white text-7xl m-0',
    text: 'w-72 pl-2 text-xs text-blue-900 font-semibold font-sans'
}
