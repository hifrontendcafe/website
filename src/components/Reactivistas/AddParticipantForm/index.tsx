  ...
  return (
    <>
      {session ? (
        ...
        >
          <div className="flex flex-wrap sm:flex-row">
            ...
            <button
              ...
              className="w-full px-3 py-2 mt-2 text-sm justify-items-end sm:w-auto sm:mt-0 sm:ml-2 font-small btn btn-primary disabled:bg-zinc-50 disabled:text-zinc-500 disabled:cursor-not-allowed"
            >
        ...
        <div className="p-6 text-zinc-200 border-2 rounded-md border-zinc-600">
