...
const Footer: React.FC<FooterProps> = ({ mainClasses }) => {
  ...
  return (
    <footer className={` ${mainClasses} bg-gray-800`}>
      <div className="container flex flex-col-reverse justify-center gap-12 py-16 mx-auto mt-40 text-gray-50 md:gap-0 md:flex-row md:justify-between">
