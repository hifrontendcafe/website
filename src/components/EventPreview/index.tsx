...
const EventPreview: React.FC<EventPreviewProps> = ({ event, past = false }) => {
  ...
  const AddToCalendar = ({ event }) => {
    ...
    const googleCalendarURL = `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${event.title
      }&dates=${formatedStartDatetime}/${formatedEndDatetime}&details=${event.description
