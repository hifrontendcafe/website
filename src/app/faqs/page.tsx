        ...
        <div className="flex flex-wrap -mx-2 lg:w-4/5 sm:mx-auto sm:mb-2">
          <div className="w-full px-4 py-2 lg:w-1/2">
            ...
            <details className="mb-4">
              ...
              <p className="p-4">
                ...
                canal y compartir un ambiente de música y chat con usuarios del
                server. En este canal están deshabilitados los micrófonos por
                defecto para poder trabajar sin interrupciones.
              </p>
            </details>
            <details className="mb-4">
              <summary className="px-4 py-2 font-semibold cursor-pointer hover:text-primary">
          ...
          <div className="w-full px-4 py-2 lg:w-1/2">
            ...
            <details className="mb-4">
              ...
              <p className="p-4">
                El programa de mentorías de FrontendCafé busca servirte de guía
                en este camino de la tecnología, conectándote con profesionales
                y referentes capacitados en los múltiples y diversos temas que
