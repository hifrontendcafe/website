  ...
  return (
    ...
    >
      ...
      <div style={{backgroundColor: '#f7f7f7'}}>
        <div className="container mx-auto py-16 flex flex-col justify-center lg:flex-row">
          <div className="flex px-5 pb-4 flex-col items-center lg:items-start md:px-20">
          ...
          <div className="px-6 pt-4 flex flex-col items-center lg:items-end text-center lg:text-right">
