  ...
  return (
    <Provider session={pageProps.session}>
      <SettingsProvider settings={pageProps.settings}>
        ...
        <CookieConsent
          disableStyles
          containerClasses="fixed mb-4 left-0 right-0 bottom-4 flex text-gray-50 justify-between px-4 py-2 items-center bg-zinc-700 z-20 container mx-auto rounded-md"
          buttonText="Aceptar"
