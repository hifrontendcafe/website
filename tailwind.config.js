  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        mainTextColor: tailwindColors.teal[200],
        logoTextColor: tailwindColors.white,
        mainBtnTxt: tailwindColors.teal[200],
        mainBtnColor: tailwindColors.teal[600],
        mainBtnHoverColor: tailwindColors.teal[800],
        mainBtnActiveColor: tailwindColors.teal[600],
      },
      textColor: {
